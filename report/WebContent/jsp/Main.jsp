...
<form id="main" action="LogOut.do" method="post" >
    <input id="selectedFstMenuId" type="hidden" name="selectedFstMenuId" value="${selectedFstMenuId}" />
	<div data-options="region:'north',border:false" style="width:100%;padding:0% 1% 1% 1%;background:#E8F1FF;">
		<table width="100%">
			<tr>
				<td width="5%" style="vertical-align:middle"><img src="${pageContext.request.contextPath}/images/logo.jpg" style="width:80%; height:80%;"/></td>
	...
	<div id="subMenu" data-options="region:'west',split:true,title:'功能菜单'" style="width:20%;height:10%;padding:0%;">
        ...
        <div id="${fstMenuItem.itemId}" class="easyui-accordion" data-options="fit:true,border:false" >
           <c:forEach items="${fstMenuItem.subMenuItem}" var="sndMenuItem">
               <div id="${sndMenuItem.itemId}" title="${sndMenuItem.itemName}" data-options="iconCls:'icon-ok'" style="overflow:auto;padding:0%;">
	...
	<div data-options="region:'south',border:false" style="width:100%;padding:0% 2% 2% 1%;text-align:center;background:#E8F1FF;color:black">Copyright(C) 2015 DHC Inc. All Right Reserved</div>
